...
uint256 hashGenesisBlock("0x0000015886acfc5aec8ec40b9b01d10e4100a974b39841aaf097bb523121c94e");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
      ...
      //vMerkleTree: 3f66108684400d84e2ffb528360d534fa19ecaf47c7c4c2ca1d1352ec4a351ad
        ...
        // Genesis block
        const char* pszTimestamp = "EBTCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x455592846008e1b93f478f2471ab9520c62b49922747357e246cd36635e97757"));
        block.print();
